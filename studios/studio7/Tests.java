...
import studio6.Methods;

public class Tests {

	@Test
	public void testarea() {
		assertEquals(3.0, Rectangle.area(1.0,3.0),.01);
	}
	
	@Test
	public void testperimeter(){
		assertEquals(8.0, Rectangle.perimeter(1.0,3.0),.01);
	}
	
	@Test
	public void testissquare(){
		assertEquals(true, Rectangle.isSquare(1.0,1.0));
	}
	
	@Test
	public void testiscompare(){
		assertEquals(true, Rectangle.compare(1.0,4.0,1.0,6.0));
	}
